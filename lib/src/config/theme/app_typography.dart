...
class AppTypography {
  ...
  static final primary = _FontStyle(
    ...
    heading34: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 34,
      fontWeight: FontWeight.bold,
    ),
    heading22: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 22,
      fontWeight: FontWeight.bold,
    ),
    title20: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 20,
      fontWeight: FontWeight.w600,
    ),
    title18: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 18,
    ),
    subHeading16: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 16,
      fontWeight: FontWeight.bold,
    ),
    body16: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 16,
    ),
    body14: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 14,
    ),
    subtitle13: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 13,
    ),
    label12: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 12,
    ),
    label11: const TextStyle().copyWith(
      color: AppColors.textBlackColor,
      fontSize: 11,
    ),
  );
