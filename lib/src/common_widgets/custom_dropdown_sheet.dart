import 'package:commconnect/src/common_widgets/custom_scrollable_bottom_sheet.dart';
import 'package:commconnect/src/common_widgets/custom_text_button.dart';
...
class CustomDropdownSheet<T> extends StatefulWidget {
  ...
  const CustomDropdownSheet({
    ...
    this.showSearch = false,
        ...
        submitButtonColor = submitButtonColor ?? AppColors.secondaryColor,
        submitButtonText = submitButtonText ?? 'DONE',
        enableMultipleSelection = enableMultipleSelection ?? false;
