import 'package:commconnect/src/helpers/extensions/string_extension.dart';
...
class FormValidator {
  ...
  /// The error message for invalid pincode input.
  static const _invalidPincodeError = 'Please enter a valid pincode';
  ...
  /// A method containing validation logic for pincode input.
  static String? pincodeValidator(String? pincode) {
    if (pincode != null && pincode.isValidZipCode) return null;
    return _invalidPincodeError;
  }
}
